...
/**
 * @ingroup  main_coredriver
 * @brief    This macro defines the Custom Name for \ref MAIN_CORE_ProtocolCallbackRegister API
 */
#define MSIInterface_ProtocolCallbackRegister MAIN_CORE_ProtocolCallbackRegister
 ...
 *             custom callback for MAIN_CORE protocol event.
 * @param[in]  protocolName - Selected protocol 
 ...
 *           or can register a custom callback function using  \ref MAIN_CORE_MSI1_ProtocolACallbackRegister.
 * @param    none
 * @return   none  
 */
 ...
 * @brief    This is the default callback with weak attribute. The user can 
 *           override and implement the default callback without weak attribute 
 *           or can register a custom callback function using  \ref MAIN_CORE_MSI1_ProtocolBCallbackRegister.
 * @param    none
 * @return   none  
 */
